...
def main(args):
      ...
      print(digitalocean.Droplet(token=os.getenv('TOKEN'), id="203453589").take_snapshot("Indian-server"))
      print(digitalocean.Droplet(token=os.getenv('TOKEN'), id="340456218").take_snapshot("Wordpress"))
